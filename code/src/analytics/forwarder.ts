...
import { Analytics, EventOptions, PageviewOptions, ScreenviewOptions, TimingOptions } from '@analytics/*';
...
export type AnalyticsReport = AnalyticsReportEvent | AnalyticsReportScreenview | AnalyticsReportPageview | AnalyticsReportTiming;
 ...
 * AnalyticsReporter is the counterpart which takes analytic reports and report them to another Analytics interface.
 */
